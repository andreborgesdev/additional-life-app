  ...
  const steps = [
    {
      ...
      description: "Sign up for free and join our community of eco-conscious individuals.",
    },
    {
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-xl text-green-700 dark:text-green-200 text-center mb-12">
            Additional Life makes it easy to give your unused items a new home and find things you need. Here's how:
          </p>

          <div className="grid gap-8 md:grid-cols-2">
            {steps.map((step, index) => (
              <div key={index} className="bg-white dark:bg-green-800 rounded-lg shadow-md p-6">
                <div className="flex items-center mb-4">
                  <div className="bg-green-500 rounded-full p-2 mr-4">
                    <Check className="text-white" size={24} />
                  </div>
                  <h2 className="text-2xl font-semibold text-green-800 dark:text-green-200">{step.title}</h2>
                </div>
          ...
          <div className="mt-12 text-center">
            <h2 className="text-2xl font-semibold text-green-800 dark:text-green-200 mb-4">Ready to Get Started?</h2>
            <a
              href="/register"

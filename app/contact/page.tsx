      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-green-800 rounded-lg shadow-lg p-8 mb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-2xl font-semibold text-green-700 dark:text-green-200 mb-4">Get in Touch</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                We'd love to hear from you! Whether you have a question about our platform, need help with your account,
                or want to share your Additional Life experience, we're here to help.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <Mail className="h-6 w-6 text-green-600 mr-2" />
                  <span className="text-gray-700 dark:text-gray-300">support@additionallife.com</span>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">123 Green Street, Eco City, EC 12345</span>
                </div>
              </div>
            </div>
            <div>
              <h2 className="text-2xl font-semibold text-green-700 dark:text-green-200 mb-4">Send Us a Message</h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-green-800 rounded-lg shadow-md p-6 flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-green-700 dark:text-green-200 mb-2">Follow Us</h3>
            ...
            <div className="bg-white dark:bg-green-800 rounded-lg shadow-md p-6 flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-green-700 dark:text-green-200 mb-2">FAQ</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Find answers to common questions about Additional Life.
              </p>
              <a href="/faq" className="mt-2 text-green-600 hover:text-green-700 transition-colors duration-300">
                View FAQ
              </a>
            </div>
            <div className="bg-white dark:bg-green-800 rounded-lg shadow-md p-6 flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-green-700 dark:text-green-200 mb-2">Community Forum</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Join discussions and share experiences with other members.
              </p>
              <a href="/forum" className="mt-2 text-green-600 hover:text-green-700 transition-colors duration-300">
                Visit Forum
              </a>
            </div>
          </div>
